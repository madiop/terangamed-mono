 ...
 * vers les appels Feign sortants. Indispensable pour que patient-service et
 * doctor-service authentifient l'utilisateur appelant via la chaîne d'appels.
 *
 * <p>Sans cet interceptor, les appels Feign seraient anonymes → 401 Unauthorized.
 *
 * <p>Pour les appels machine-to-machine (jobs, consumers Kafka), il faudra
 * utiliser un flow {@code client_credentials} et un interceptor distinct
 * — non requis à ce stade.
 */
@Configuration
